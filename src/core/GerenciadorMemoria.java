...
public class GerenciadorMemoria {
    ...
    TLB tlb;
    int pageFaults = 0;
    private static final int TAMANHO_PAGINA = 1024; // bytes
    ...
    public GerenciadorMemoria(int quadros, int entradasTLB, int conjuntosTLB, GerenciadorMemoriaGUI gui) {
        ...
        tlb = new TLB(entradasTLB, conjuntosTLB); // usa nova TLB com conjuntos
        this.gui = gui;
    ...
    public void executarComando(String linha) {
        linha = linha.trim();
        if (linha.isEmpty() || linha.startsWith("//")) return;
        ...
        switch (comando) {
            ...
            case "W": {
                ...
                tlb.inserir(pid, pagina, pagina); // Você pode adaptar esse 'quadro' se necessário
